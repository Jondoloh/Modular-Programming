...
parser.add_argument('-n','--num_epochs',help = 'This is the name of the epochs',type=int,required = True)
...
model_trained, percent, val_loss, val_acc, train_loss, train_acc= train(model, criterion, train_loader, val_loader, optimizer, num_epochs)
