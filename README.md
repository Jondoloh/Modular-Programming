...
<img src="images/dog.0.jpg" align="right"> -->
  ...
  Cat            |  Dog
:--------------:|:--------:
![](figures/cat.2.jpg)  |  ![](figures/dog.3.jpg)
...
<div style="display:flex;align-items:center">
    <div>
        <h5> <a href='..'> Mr. John Ndolo </a> </h5> <img src="images/cat.3.jpg" height= 7% width= 7%>
<div>
    <h5> <a href='.'> Mr. Benjamin Benteke(My Tutor) </a> </h5> <img src="images/dog.5.jpg" height= 7% width= 7%>
    
<div>
    <h5> <a href='.'> Mm. K </a> </h5> <img src="images/cat.4.jpg" height= 7% width= 7%>
